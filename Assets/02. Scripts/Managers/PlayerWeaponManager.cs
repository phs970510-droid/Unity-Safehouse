...
public class PlayerWeaponManager : MonoBehaviour
{
    ...
    public void ChangeWeapon(int index)
    {
        ...
        {
            Debug.Log($"[PlayerWeaponManager] {targetWeapon.weaponData.weaponName}은(는) 아직 해금되지 않았습니다.");
            return;
        }
        ...
        Debug.Log($"[PlayerWeaponManager] 무기 전환: {CurrentWeapon.weaponData.weaponName}");
    }
}